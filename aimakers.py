...
QUESTIONS = {
    "A": [
        ("Q1. 도서관에 무서운 마녀가 나타났다! 너라면?",
         [("함께 맞서 싸운다", "0.png", "마을 사람들을 모아 함께 맞서 싸운다"),
          ("약점을 연구한다", "00.png", "혼자 조용히 마녀의 약점을 연구한다")], "EI"),
        ("Q2. 오래된 마법서를 발견했다. 너는 무엇을 볼래?",
         [("역사적 사실", "1.jpg", "책에 적힌 역사적 사실과 기록들"),
          ("신비로운 미래", "2.png", "이 마법이 불러올 신비로운 미래")], "SN"),
        ("Q3. 마녀에게 잡힌 친구가 울고 있다. 너는?",
         [("냉철한 계획", "5.jpg", "냉철하게 탈출 계획을 세워준다"),
          ("따뜻한 위로", "6.png", "친구를 꽉 안아주며 위로해준다")], "TF"),
        ("Q4. 마법 주문을 외워야 한다면?",
         [("완벽한 암기", "3.jpg", "주문서를 꼼꼼히 읽고 순서대로 외운다"),
          ("즉흥적인 감각", "4.jpg", "느낌이 오는 대로 즉흥적으로 외친다")], "JP"),
    ],
    "B": [
        ("Q1. 마을의 거대 로봇이 고장 났다! 너라면?",
         [("기술자 소집", "7.jpg", "기술자들을 소집해 회의를 연다"),
          ("혼자 수리", "8.png", "방 안에 틀어박혀 혼자 부품을 뜯어본다")], "EI"),
        ("Q2. 새로운 발명품 설계도를 보게 되었다. 너는?",
         [("정확한 수치", "9.jpg", "설계도의 수치가 정확한지 체크한다"),
          ("멋진 상상", "10.png", "이 발명품이 바꿀 멋진 세상을 상상한다")], "SN"),
        ("Q3. 로봇이 슬픈 눈을 하고 쳐다본다면?",
         [("결함 수리", "11.png", "기계적 결함이 있는지 즉시 수리한다"),
          ("마음 걱정", "12.png", "로봇의 마음이 아픈 건 아닐지 걱정한다")], "TF"),
        ("Q4. 중요한 실험을 앞두고 너는?",
         [("단계별 정리", "14.png", "실험 단계를 1번부터 10번까지 정리한다"),
          ("일단 실행", "15.jpg", "일단 버튼을 누르며 직접 배워본다")], "JP"),
    ],
    "C": [
        ("Q1. 숲속에서 요정들의 축제가 열렸다! 너는?",
         [("함께 춤추기", "16.jpg", "무대 한가운데서 춤을 추며 즐긴다"),
          ("조용히 관찰", "17.jpg", "조용한 구석에서 축제를 관찰한다")], "EI"),
        ("Q2. 신비로운 꽃을 발견했다. 너는?",
         [("형태 관찰", "18.png", "꽃잎의 개수와 모양을 관찰한다"),
          ("전설 상상", "19.png", "이 꽃에 담긴 전설을 떠올려본다")], "SN"),
        ("Q3. 요정 여왕이 내 작품을 평가한다면?",
         [("솔직한 피드백", "20.png", "고쳐야 할 점을 솔직하게 말해주길 바란다"),
          ("따뜻한 칭찬", "21.png", "내 노력을 칭찬해주길 바란다")], "TF"),
        ("Q4. 내일 열릴 공연을 위해 너는?",
         [("완벽한 스케줄", "23.png", "연습 스케줄을 완벽하게 짜놓는다"),
          ("그날의 영감", "22.png", "그날의 영감에 따라 공연하기로 한다")], "JP"),
    ],
}
